...
public class botAutonomousBlue extends LinearOpMode {
    ...
    private static final double SHOOTER_TARGET_RPM = 2000;
    ...
    public void runOpMode() {
        ...
        // Driving backwards to mid
        driveForward_BackStart(END_DRIVE_POWER);
        sleep((long) (4000));
        stopDrive();
        driveMecanum(0.0, 0.0, -.3); sleep(700); driveMecanum(0.0, 0.0, 0.0);
